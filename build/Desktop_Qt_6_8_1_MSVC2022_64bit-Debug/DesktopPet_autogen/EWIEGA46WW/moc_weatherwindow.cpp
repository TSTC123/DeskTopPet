...
static constexpr auto qt_meta_stringdata_ZN13WeatherWindowE = QtMocHelpers::stringData(
    "WeatherWindow",
    "fetchWeatherData",
    "",
    "handleWeatherData",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13WeatherWindowE[] = {
...
Q_CONSTINIT const QMetaObject WeatherWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13WeatherWindowE.offsetsAndSizes,
    qt_meta_data_ZN13WeatherWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13WeatherWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<WeatherWindow, std::true_type>,
        // method 'fetchWeatherData'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handleWeatherData'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void WeatherWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->fetchWeatherData(); break;
        case 1: _t->handleWeatherData((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
...
void *WeatherWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13WeatherWindowE.stringdata0))
